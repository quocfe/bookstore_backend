...
var reviewController = {
  index: function () {
    var _index = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
      var _req$query, page, limit, offset, reviews, _yield$Review$countTo, _yield$Review$countTo2, totaPageData, totalPage;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            offset = (page - 1) * limit;
            _context.next = 5;
            return _Review["default"].selectAll(limit, offset);
          case 5:
            reviews = _context.sent;
            _context.next = 8;
            return _Review["default"].countTotal();
          case 8:
            _yield$Review$countTo = _context.sent;
            _yield$Review$countTo2 = _slicedToArray(_yield$Review$countTo, 1);
            totaPageData = _yield$Review$countTo2[0];
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _Review["default"].selectOne(id);
          case 4:
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return _Review["default"].insert(newReview);
          case 4:
            res.status(200).json({
              message: 'success'
            });
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            _context4.next = 4;
            return _Review["default"]["delete"](idReview);
          case 4:
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 5;
            return _Review["default"].update(idReview, newReview);
          case 5:
  ...
  selectReviewWithProduct: function () {
    var _selectReviewWithProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
      var idProduct, review;
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 4;
            return _Review["default"].selectReviewWithProduct(idProduct);
          case 4:
    ...
    function selectReviewWithProduct(_x13, _x14) {
      return _selectReviewWithProduct.apply(this, arguments);
    }
    return selectReviewWithProduct;
  }(),
  updateView: function () {
    var _updateView = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
      var id;
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.prev = 1;
            _context8.next = 4;
            return _Review["default"].updateView(id);
          case 4:
    ...
    function updateView(_x15, _x16) {
      return _updateView.apply(this, arguments);
    }
    return updateView;
  }()
};
var _default = exports["default"] = reviewController;